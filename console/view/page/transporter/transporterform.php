<div class="card mb-3">
    ...
    <div class="col-lg-10">
        <div class="card-body">
            ...
            ?>
            <h1>ADD FORM</h1>
            <form method="post" action="index.php?controller=transportercontroller&action=add" enctype=multipart/form-data>
                ...
                <form method="post" action="index.php?controller=transportercontroller&action=edit" enctype=multipart/form-data>
                <div class="form-group">
                    <label>Name:</label>
                ...
                <div class="form-group">
                    <label>Mobile Number:</label>
                    <input type="text" name="mobileno" class="form-control" value="<?php echo $val['mobileno']; ?>" required>
                </div>
