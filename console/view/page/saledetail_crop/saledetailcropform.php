<div class="card mb-3">
    ...
    <div class="col-lg-10">
        <div class="card-body">
            ...
            ?>
            <h1>ADD FORM</h1>
            <form method="post" action="index.php?controller=saledetailcropcontroller&action=add" enctype=multipart/form-data>
                ...
                <form method="post" action="index.php?controller=saledetailcropcontroller&action=edit">
                <div class="form-group">
                    <label>Quantity:</label>
