...
function getCallbackUrl($order)
{
	...
	return $url. 'response.php?order_id='.$order;
}
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<form action="#" id="payment_form">
					 ...
					 <input type="text" class="form-control" id="surl" name="surl" value="<?php echo getCallbackUrl($_REQUEST['order_id']); ?>" />
					 <input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="Hu9y9QwChK" />
					 <input type="hidden" id="key" name="key" placeholder="Merchant Key" value="AsWeutsH" />
    				...
    				<input type="hidden" id="pinfo" name="pinfo" placeholder="Product Info" value="P01,P02" />
					 ...
					 <div class="form-group">
					 	<label>Amount</label>
					 	<input class="form-control" type="text" class="form-control" id="amount" name="amount" placeholder="Amount" value="<?php echo $_REQUEST['amount']; ?>" />
					 </div>
					 ...
					 <div class="form-group">
					 	 <label>Hash:</label>
					     <input type="text" class="form-control" id="hash" name="hash" placeholder="Hash" value="" />
					 </div>
