<?php 
    class SaleDetailFpController extends Controller
    {
        private $tbl = 'saledetail_fp'; 
        public function loadview($action)
        {
            ...
            if($action == 'listdata')
            {
               $row = $this->getMasterData($this->tbl);         
                ...
                include 'page/saledetail_fp/saledetailfplist.php';                
                
            }
            
            if($action == "addform")
            {
                include 'page/saledetail_fp/saledetailfpform.php';
            }
            ...
            if($action == "add")
            {
               ...
               $this->redirect("index.php?controller=saledetailfpcontroller&action=listdata");
