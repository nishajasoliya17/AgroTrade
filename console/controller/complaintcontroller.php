        ...
        public function loadview($action)
        {
            ...
            if($action == 'listdata')
            {
               $row = $this->getMasterData($this->tbl);         
                ...
                include 'page/complaint/complaintlist.php';                
                
            }
            
            if($action == "addform")
            {
                include 'page/complaint/complaintform.php';
            }
            ...
            if($action == "add")
            {
               ...
               $this->redirect("index.php?controller=complaintcontroller&action=listdata");
