<?php 
    class FertiPestiInfoController extends Controller
    {
        private $tbl = 'ferti_pesti_info'; 
        public function loadview($action)
        {
            ...
            if($action == 'listdata')
            {
               $row = $this->getMasterData($this->tbl);         
                ...
                include 'page/ferti_pesti_info/ferti_pesti_info_list.php';                
                
            }
            
            if($action == "addform")
            {
                include 'page/ferti_pesti_info/ferti_pesti_info_form.php';
            }
            ...
            if($action == "add")
            {
               ...
               $this->redirect("index.php?controller=fertipestiinfocontroller&action=listdata");
