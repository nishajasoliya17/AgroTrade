        ...
        public function loadview($action)
		{
			...
			if($action == 'listdata')
			{
               $row = $this->getMasterData($this->tbl);         
                ...
                include 'page/transporter/transporterlist.php';                
                
            }
            
            if($action == "addform")
            {
                include 'page/transporter/transporterform.php';
            }
            ...
            if($action == "add")
            {
               ...
               $this->redirect("index.php?controller=transportercontroller&action=listdata");
